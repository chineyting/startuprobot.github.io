...
;( function( window ) {
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlPrevious = createElement( 'button', { cName : 'fs-previous',  inner : 'PR', appendTo : this.ctrls } );
		this._showCtrl( this.ctrlPrevious );

		this.ctrlNext = createElement( 'button', { cName : 'fs-next', inner : 'NE', appendTo : this.ctrls } );
		this._showCtrl( this.ctrlNext );
	...
	FForm.prototype._initEvents = function() {
		...
		// keyboard navigation events - jump to next field when pressing 
	...
	FForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			case 'NOVAL' : 
				...
				break;
			case 'INVALIDEMAIL' : 
				message = 'We’ll need to communicate mainly by email. Don’t worry, we hate spam too, so we don’t send any.';
				break;
			// ...
		};
